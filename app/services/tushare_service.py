...
class TushareService:
    ...
    def normalize_income(self, df: pd.DataFrame) -> list[dict[str, Any]]:
        ...
        numeric_fields = [
            "biz_tax_surchg", "rd_exp", "fin_exp_int_exp", "fin_exp_int_inc",
            "fv_value_chg_gain", "oth_income", "asset_disp_income",
            "non_oper_income", "non_oper_exp", "credit_impa_loss",
            "oth_impair_loss_assets",
        ...
        for row in self._df_to_records(df):
            item = {
                ...
                "end_type": self._clean_str(row.get("end_type")),
    ...
    def normalize_balance_sheet(self, df: pd.DataFrame) -> list[dict[str, Any]]:
        ...
        numeric_fields = [
            ...
            "st_borr", "non_cur_liab_due_1y", "lt_borr", "st_bonds_payable",
            "notes_payable", "acct_payable", "adv_receipts", "lease_liab",
            "total_cur_liab", "bond_payable", "total_ncl", "total_liab",
            "total_hldr_eqy_exc_min_int", "total_hldr_eqy_inc_min_int",
            "accounts_receiv_bill", "accounts_pay", "contract_assets",
            "contract_liab", "goodwill", "intan_assets", "fix_assets_total",
            "cip_total",
        ]
    ...
    def normalize_cashflow(self, df: pd.DataFrame) -> list[dict[str, Any]]:
        ...
        numeric_fields = [
            "c_fr_oth_operate_a", "c_inf_fr_operate_a", "oth_cash_pay_oper_act",
            "st_cash_out_act", "stot_inflows_inv_act", "c_pay_acq_const_fiolta",
            "c_paid_invest", "stot_out_inv_act", "c_recp_cap_contrib",
            "oth_cash_recp_ral_fnc_act", "stot_cash_in_fnc_act",
            "stot_cashout_fnc_act", "net_profit", "depr_fa_coga_dpba",
            "amort_intang_assets", "decr_inventories", "decr_oper_payable",
            "incr_oper_payable", "im_net_cashflow_oper_act",
